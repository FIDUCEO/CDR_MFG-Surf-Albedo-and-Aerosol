...
# define CATCH_INTERNAL_SUPPRESS_ETD_WARNINGS _Pragma( "clang diagnostic push" ) _Pragma( "clang diagnostic ignored \"-Wexit-time-destructors\"" )
...
void registerTestCaseFunction
    ...
    #define INTERNAL_CATCH_TESTCASE2( TestName, ... ) static void TestName(); CATCH_INTERNAL_SUPPRESS_ETD_WARNINGS namespace{ Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME( autoRegistrar )( &TestName, CATCH_INTERNAL_LINEINFO, Catch::NameAndDesc( __VA_ARGS__ ) ); } CATCH_INTERNAL_UNSUPPRESS_ETD_WARNINGS static void TestName()
    ...
    #define INTERNAL_CATCH_METHOD_AS_TEST_CASE( QualifiedMethod, ... ) CATCH_INTERNAL_SUPPRESS_ETD_WARNINGS namespace{ Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME( autoRegistrar )( &QualifiedMethod, "&" #QualifiedMethod, Catch::NameAndDesc( __VA_ARGS__ ), CATCH_INTERNAL_LINEINFO ); } CATCH_INTERNAL_UNSUPPRESS_ETD_WARNINGS
    #define INTERNAL_CATCH_TEST_CASE_METHOD2( TestName, ClassName, ... ) CATCH_INTERNAL_SUPPRESS_ETD_WARNINGS namespace{ struct TestName : ClassName{ void test(); }; Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME( autoRegistrar ) ( &TestName::test, #ClassName, Catch::NameAndDesc( __VA_ARGS__ ), CATCH_INTERNAL_LINEINFO ); } CATCH_INTERNAL_UNSUPPRESS_ETD_WARNINGS void TestName::test()
    ...
    #define INTERNAL_CATCH_REGISTER_TESTCASE( Function, ... ) CATCH_INTERNAL_SUPPRESS_ETD_WARNINGS Catch::AutoReg( Function, CATCH_INTERNAL_LINEINFO, Catch::NameAndDesc( __VA_ARGS__ ) ); CATCH_INTERNAL_UNSUPPRESS_ETD_WARNINGS
#else
    #define INTERNAL_CATCH_TESTCASE2( TestName, Name, Desc ) static void TestName(); CATCH_INTERNAL_SUPPRESS_ETD_WARNINGS namespace{ Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME( autoRegistrar )( &TestName, CATCH_INTERNAL_LINEINFO, Catch::NameAndDesc( Name, Desc ) ); } CATCH_INTERNAL_UNSUPPRESS_ETD_WARNINGS static void TestName()
    ...
    #define INTERNAL_CATCH_METHOD_AS_TEST_CASE( QualifiedMethod, Name, Desc ) CATCH_INTERNAL_SUPPRESS_ETD_WARNINGS namespace{ Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME( autoRegistrar )( &QualifiedMethod, "&" #QualifiedMethod, Catch::NameAndDesc( Name, Desc ), CATCH_INTERNAL_LINEINFO ); } CATCH_INTERNAL_UNSUPPRESS_ETD_WARNINGS
    #define INTERNAL_CATCH_TEST_CASE_METHOD2( TestCaseName, ClassName, TestName, Desc ) CATCH_INTERNAL_SUPPRESS_ETD_WARNINGS namespace{ struct TestCaseName : ClassName{ void test(); }; Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME( autoRegistrar ) ( &TestCaseName::test, #ClassName, Catch::NameAndDesc( TestName, Desc ), CATCH_INTERNAL_LINEINFO ); } CATCH_INTERNAL_UNSUPPRESS_ETD_WARNINGS void TestCaseName::test()
    ...
    #define INTERNAL_CATCH_REGISTER_TESTCASE( Function, Name, Desc ) CATCH_INTERNAL_SUPPRESS_ETD_WARNINGS Catch::AutoReg( Function, CATCH_INTERNAL_LINEINFO, Catch::NameAndDesc( Name, Desc ) ); CATCH_INTERNAL_UNSUPPRESS_ETD_WARNINGS
#endif
...
#elif defined(1) || defined(__linux) || defined(__linux__)
...
#endif
#define INTERNAL_CATCH_TEST( macroName, resultDisposition, expr ) do { Catch::ResultBuilder __catchResult( macroName, CATCH_INTERNAL_LINEINFO, CATCH_INTERNAL_STRINGIFY(expr), resultDisposition ); try { CATCH_INTERNAL_SUPPRESS_PARENTHESES_WARNINGS ( __catchResult <= expr ).endExpression(); CATCH_INTERNAL_UNSUPPRESS_PARENTHESES_WARNINGS } catch( ... ) { __catchResult.useActiveException( resultDisposition ); } INTERNAL_CATCH_REACT( __catchResult ) } while( Catch::isTrue( false && static_cast<bool>( !!(expr) ) ) )
#define INTERNAL_CATCH_IF( macroName, resultDisposition, expr ) INTERNAL_CATCH_TEST( macroName, resultDisposition, expr ); if( Catch::getResultCapture().lastAssertionPassed() )
#define INTERNAL_CATCH_ELSE( macroName, resultDisposition, expr ) INTERNAL_CATCH_TEST( macroName, resultDisposition, expr ); if( !Catch::getResultCapture().lastAssertionPassed() )
...
#ifdef CATCH_CONFIG_VARIADIC_MACROS
    #define INTERNAL_CATCH_MSG( macroName, messageType, resultDisposition, ... ) do { Catch::ResultBuilder __catchResult( macroName, CATCH_INTERNAL_LINEINFO, "", resultDisposition ); __catchResult << __VA_ARGS__ + ::Catch::StreamEndStop(); __catchResult.captureResult( messageType ); INTERNAL_CATCH_REACT( __catchResult ) } while( Catch::alwaysFalse() )
#else
    #define INTERNAL_CATCH_MSG( macroName, messageType, resultDisposition, log ) do { Catch::ResultBuilder __catchResult( macroName, CATCH_INTERNAL_LINEINFO, "", resultDisposition ); __catchResult << log + ::Catch::StreamEndStop(); __catchResult.captureResult( messageType ); INTERNAL_CATCH_REACT( __catchResult ) } while( Catch::alwaysFalse() )
#endif
...
#define INTERNAL_CATCH_TRANSLATE_EXCEPTION2( translatorName, signature ) static std::string translatorName( signature ); namespace{ Catch::ExceptionTranslatorRegistrar INTERNAL_CATCH_UNIQUE_NAME( catch_internal_ExceptionRegistrar )( &translatorName ); } static std::string translatorName( signature )
...
namespace Catch {
    ...
    AssertionResult ResultBuilder::build( DecomposedExpression const& expr ) const
    {
        ...
        data.decomposedExpression = &expr;
...
#define INTERNAL_CATCH_REGISTER_LISTENER( listenerType ) namespace{ Catch::ListenerRegistrar<listenerType> catch_internal_RegistrarFor##listenerType; }
#define CATCH_REGISTER_LISTENER( listenerType ) namespace{ Catch::ListenerRegistrar<listenerType> catch_internal_RegistrarFor##listenerType; }
